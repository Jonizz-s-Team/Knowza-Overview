...
> Knowza AI is a **separate product** from the LMS. No new AI features shipped in this release. Security refinements and tenant scoping improvements in this cycle (`33b6656`) also harden the data boundary that Knowza AI respects when reading per-user profiles and chat histories.
